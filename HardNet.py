...
def main(patches):
    ...
    # except:
          ...
          # sys.exit(1)
    model_weights = './HardNet/HardNet++.pth'
    model = HardNet()
    ...
    # print('Amount of patches: {}'.format(n_patches))
        ...
        #t = time.time()
        #save_name='C:/Users/25464/Desktop/paper/match/code/boat/keynet/dc/6.mat'
        #patches = io.loadmat(r'C:\Users\25464\Desktop\paper\match\code\boat\keynet\6.mat')
    #patches=h5py.File(r'C:\Users\25464\Desktop\paper\match\code\boat\1.mat')
        #patches=np.array(patches['N']).astype(np.float32)
        #print(patches)
    #[n,m,x,y]=patches.size()
